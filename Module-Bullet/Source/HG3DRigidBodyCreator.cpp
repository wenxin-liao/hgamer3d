...
// Static Plane
btRigidBody* HG3DRigidBodyCreator::createStaticPlane(btScalar mass, const btVector3* pos, const btQuaternion* qt, const btVector3* origin)
{
	btCollisionShape *shape = new btStaticPlaneShape(*origin,1);
	return createRigidBody(mass, shape, pos, qt);
};
